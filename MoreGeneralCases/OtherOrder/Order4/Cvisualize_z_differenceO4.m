...
% 初始化参数范围
K_values = linspace(0,900, 100);  % K从0到5，取20个值
omega0_values = linspace(0, 1200, 100);  % 标准差从0.1到2，取20个值
...
save('z1Order4Sim910D1_9001200.mat', 'mm1'); % 保存数据到文件 
save('z2Order4Sim910D1_9001200.mat', 'mm2'); % 保存数据到文件 
