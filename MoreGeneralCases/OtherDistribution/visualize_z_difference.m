...
% 初始化参数范围
K_values = linspace(0,100, 100);  % K从0到100，取100个值
omega0_values = linspace(0, 100, 100);  % omega0从0到100，取100个值
...
parfor i = 1:length(K_values)
    for j = 1:SL
        K = K_values(i);  % 当前K值
            omega0_values = linspace(0, 100, 100);  % 标准差从0.1到2，取20个值
...
save('z1GauSim910D1_100100.mat', 'mm1'); % 保存数据到文件 
save('z2GauSim910D1_100100.mat', 'mm2'); % 保存数据到文件 
